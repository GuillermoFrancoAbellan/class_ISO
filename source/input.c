    ...
    if (ppt->has_scalars == _TRUE_) {
      ...
      if ((ppt->has_bi == _TRUE_) ||
        ...
        /* general case, but if pii2 or pri2=0 the code interprets it
          ...
          // GFA: Moved these error to the start of the primordial module, to play nice with MontePython
        ...
        //  GFA: Old solution, but I'm not sure if it was working correctly
